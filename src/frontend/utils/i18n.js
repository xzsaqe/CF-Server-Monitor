...
const translations = reactive({
  en: {
    ...
    customThemeUrlDesc: 'Paste a custom third-party theme URL and switch to it directly.',
  ...
  zh: {
    ...
    customThemeUrlDesc: '粘贴自定义第三方github主题构建产物地址，注意加入cmmmitid固定版本，比如https://github.com/Author/theme/tree/commitid',
